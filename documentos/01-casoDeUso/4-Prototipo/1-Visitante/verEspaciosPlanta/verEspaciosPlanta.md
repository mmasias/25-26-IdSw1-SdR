...
# verEspaciosPlanta() -> Detalle y prototipado

## Diagrama de especificación

<div align=center>

|![Caso de uso: verEspaciosPlanta()](/documentos/01-casoDeUso/3-DetallarCasosDeUso/1-Visitante/verEspaciosPlanta/verEspaciosPlanta.svg)|
|-|
|Código fuente: [especificacion.puml](/documentos/01-casoDeUso/3-DetallarCasosDeUso/1-Visitante/verEspaciosPlanta/verEspaciosPlanta.puml)|
